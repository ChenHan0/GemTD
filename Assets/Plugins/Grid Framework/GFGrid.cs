...
public abstract class GFGrid : MonoBehaviour {
  ...
  //  protected Material defaultRenderMaterial{get{return new Material( "Shader \"Lines/Colored Blended\" {" +
    ...
    protected Material defaultRenderMaterial
    {
        get
        {
            return new Material((Shader)UnityEditor.AssetDatabase.LoadAssetAtPath("Assets/Shader/DefaultRenderMaterialShader.shader", typeof(Shader)));
        }
    }
